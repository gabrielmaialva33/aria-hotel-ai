...
from aria.core.database.models import Reservation, Message, Guest
...
class AnalyticsDashboard:
    ...
    async def get_ai_metrics(
        ...
        async with get_db() as db:
            ...
            resolution_rate = ((total_conversations - transferred_conversations) / total_conversations * 100) if total_conversations > 0 else 100
