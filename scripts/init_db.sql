...
(
    50
), -- whatsapp, website, booking.com, etc
...
(
    20
) NOT NULL, -- user, assistant, system
...
(
    50
) NOT NULL, -- housekeeping, restaurant, laundry, etc
    status VARCHAR
(
    50
) NOT NULL DEFAULT 'pending',
...
(
    50
) NOT NULL, -- pix, credit_card, debit_card, cash
    status VARCHAR
(
    50
) NOT NULL DEFAULT 'pending',
...
(
    50
) NOT NULL, -- room, food, activities, etc
    preference VARCHAR
(
    100
) NOT NULL,
...
(
    50
) NOT NULL, -- promotional, seasonal, retention
    status VARCHAR
(
    50
) DEFAULT 'draft',
...
-- Insert initial data
INSERT INTO guests (name, email, phone, preferences)
VALUES ('Sistema', 'system@hotelpassarim.com.br', '+000000000000', '{"type": "system"}') ON CONFLICT (phone) DO NOTHING;
